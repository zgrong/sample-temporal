...
export const schema = {
  ...
  workflows: {
    ...
    onboardingFlowDisabled: {
      ...
      format: Boolean,
      default: false,
      env: 'ENGINE_ONBOARDING_FLOW_DISABLED',
    },
    callerPolicyDefaultOption: {
      ...
      env: 'ENGINE_WORKFLOW_CALLER_POLICY_DEFAULT_OPTION',
    },
  },
  ...
  queue: {
    ...
    bull: {
      ...
      gracefulShutdownTimeout: {
        doc: '[DEPRECATED] (Use ENGINE_GRACEFUL_SHUTDOWN_TIMEOUT instead) How long should n8n wait for running executions before exiting worker process (seconds)',
        format: Number,
        default: 30,
  ...
  generic: {
    ...
    gracefulShutdownTimeout: {
      ...
      format: Number,
      default: 30,
      env: 'ENGINE_GRACEFUL_SHUTDOWN_TIMEOUT',
    },
  },
  ...
  security: {
    restrictFileAccessTo: {
      ...
      format: String,
      default: '',
      env: 'ENGINE_RESTRICT_FILE_ACCESS_TO',
    },
    blockFileAccessToN8nFiles: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_BLOCK_FILE_ACCESS_TO_ENGINE_FILES',
    },
    audit: {
      daysAbandonedWorkflow: {
        ...
        format: Number,
        default: 90,
        env: 'ENGINE_SECURITY_AUDIT_DAYS_ABANDONED_WORKFLOW',
      },
    },
    excludeEndpoints: {
      ...
      format: String,
      default: '',
      env: 'ENGINE_AUTH_EXCLUDE_ENDPOINTS',
    },
  },
  ...
  publicApi: {
    disabled: {
      format: Boolean,
      default: false,
      env: 'ENGINE_PUBLIC_API_DISABLED',
      doc: 'Whether to disable the Public API',
    },
    path: {
      format: String,
      default: 'api',
      env: 'ENGINE_PUBLIC_API_ENDPOINT',
    ...
    swaggerUi: {
      disabled: {
        format: Boolean,
        default: false,
        env: 'ENGINE_PUBLIC_API_SWAGGERUI_DISABLED',
  ...
  workflowTagsDisabled: {
    format: Boolean,
    default: false,
    env: 'ENGINE_WORKFLOW_TAGS_DISABLED',
  ...
  userManagement: {
    jwtSecret: {
      ...
      format: String,
      default: '',
      env: 'ENGINE_USER_MANAGEMENT_JWT_SECRET',
    },
    ...
    emails: {
      ...
      smtp: {
        host: {
          ...
          default: '',
          env: 'ENGINE_SMTP_HOST',
        },
        port: {
          doc: 'SMTP server port',
          format: Number,
          default: 465,
          env: 'ENGINE_SMTP_PORT',
        },
        secure: {
        ...
        auth: {
          user: {
            ...
            default: '',
            env: 'ENGINE_SMTP_USER',
          },
          pass: {
            doc: 'SMTP login password',
            format: String,
            default: '',
            env: 'ENGINE_SMTP_PASS',
          },
          serviceClient: {
            doc: 'SMTP OAuth Service Client',
            format: String,
            default: '',
            env: 'ENGINE_SMTP_OAUTH_SERVICE_CLIENT',
          },
          privateKey: {
            doc: 'SMTP OAuth Private Key',
            format: String,
            default: '',
            env: 'ENGINE_SMTP_OAUTH_PRIVATE_KEY',
          },
        },
        sender: {
      ...
      templates: {
        invite: {
          ...
          format: String,
          default: '',
          env: 'ENGINE_UM_EMAIL_TEMPLATES_INVITE',
        },
        passwordReset: {
          doc: 'Overrides default HTML template for resetting password (use full path)',
          format: String,
          default: '',
          env: 'ENGINE_UM_EMAIL_TEMPLATES_PWRESET',
        },
      },
    },
  ...
  logs: {
    ...
    file: {
      fileCountMax: {
        ...
        format: Number,
        default: 100,
        env: 'ENGINE_LOG_FILE_COUNT_MAX',
      },
      fileSizeMax: {
        doc: 'Maximum size for each log file in MB.',
        format: Number,
        default: 16,
        env: 'ENGINE_LOG_FILE_SIZE_MAX',
      },
      location: {
        doc: 'Log file location; only used if log output is set to file.',
        format: String,
        default: path.join('..todo..', 'logs/n8n.log'),
        env: 'ENGINE_LOG_FILE_LOCATION',
      },
    },
  },
  ...
  versionNotifications: {
    ...
    infoUrl: {
      ...
      env: 'ENGINE_VERSION_NOTIFICATIONS_INFO_URL',
    },
  },
  ...
  externalStorage: {
    s3: {
      host: {
        format: String,
        default: '',
        env: 'ENGINE_EXTERNAL_STORAGE_S3_HOST',
      ...
      bucket: {
        name: {
          format: String,
          default: '',
          env: 'ENGINE_EXTERNAL_STORAGE_S3_BUCKET_NAME',
          doc: 'Name of the n8n bucket in S3-compatible external storage',
        },
        region: {
          format: String,
          default: '',
          env: 'ENGINE_EXTERNAL_STORAGE_S3_BUCKET_REGION',
      ...
      credentials: {
        accessKey: {
          format: String,
          default: '',
          env: 'ENGINE_EXTERNAL_STORAGE_S3_ACCESS_KEY',
          doc: 'Access key in S3-compatible external storage',
        },
        accessSecret: {
          format: String,
          default: '',
          env: 'ENGINE_EXTERNAL_STORAGE_S3_ACCESS_SECRET',
  ...
  externalSecrets: {
    updateInterval: {
      format: Number,
      default: 300,
      env: 'ENGINE_EXTERNAL_SECRETS_UPDATE_INTERVAL',
      doc: 'How often (in seconds) to check for secret updates.',
    },
    preferGet: {
      format: Boolean,
      default: false,
      env: 'ENGINE_EXTERNAL_SECRETS_PREFER_GET',
  ...
  hiringBanner: {
    enabled: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_HIRING_BANNER_ENABLED',
    },
  },
  ...
  personalization: {
    enabled: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_PERSONALIZATION_ENABLED',
    },
  },
  ...
  diagnostics: {
    enabled: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_DIAGNOSTICS_ENABLED',
    },
    config: {
      posthog: {
        apiKey: {
          ...
          env: 'ENGINE_DIAGNOSTICS_POSTHOG_API_KEY',
        },
        apiHost: {
          doc: 'API host for PostHog',
          format: String,
          default: 'https://ph.n8n.io',
          env: 'ENGINE_DIAGNOSTICS_POSTHOG_API_HOST',
        },
        disableSessionRecording: {
          doc: 'Disable posthog session recording',
          format: Boolean,
          default: true,
          env: 'ENGINE_DIAGNOSTICS_POSTHOG_DISABLE_RECORDING',
        },
      },
      sentry: {
        dsn: {
  ...
  onboardingCallPrompt: {
    enabled: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_ONBOARDING_CALL_PROMPTS_ENABLED',
    },
  },
  ...
  eventBus: {
    checkUnsentInterval: {
      ...
      format: Number,
      default: 0,
      env: 'ENGINE_EVENTBUS_CHECKUNSENTINTERVAL',
    },
    logWriter: {
      keepLogCount: {
        ...
        format: Number,
        default: 3,
        env: 'ENGINE_EVENTBUS_LOGWRITER_KEEPLOGCOUNT',
      },
      maxFileSizeInKB: {
        doc: 'Maximum size of an event log file before a new one is started.',
        format: Number,
        default: 10240, // 10MB
        env: 'ENGINE_EVENTBUS_LOGWRITER_MAXFILESIZEINKB',
      },
      logBaseName: {
        doc: 'Basename of the event log file.',
        format: String,
        default: 'n8nEventLog',
        env: 'ENGINE_EVENTBUS_LOGWRITER_LOGBASENAME',
      },
    },
    crashRecoveryMode: {
      ...
      default: 'extensive',
      env: 'ENGINE_EVENTBUS_RECOVERY_MODE',
    },
  },
  ...
  expression: {
    evaluator: {
      ...
      default: 'tournament',
      env: 'ENGINE_EXPRESSION_EVALUATOR',
    },
    reportDifference: {
      doc: 'Whether to report differences in the evaluator outputs',
      format: Boolean,
      default: false,
      env: 'ENGINE_EXPRESSION_REPORT_DIFFERENCE',
    },
  },
  ...
  sourceControl: {
    defaultKeyPairType: {
      ...
      default: 'ed25519',
      env: 'ENGINE_SOURCECONTROL_DEFAULT_SSH_KEY_TYPE',
    },
  },
  ...
  workflowHistory: {
    enabled: {
      ...
      format: Boolean,
      default: true,
      env: 'ENGINE_WORKFLOW_HISTORY_ENABLED',
    },
    ...
    pruneTime: {
      ...
      format: Number,
      default: -1,
      env: 'ENGINE_WORKFLOW_HISTORY_PRUNE_TIME',
    },
  },
